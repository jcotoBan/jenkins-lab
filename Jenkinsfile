      ...
      parallel {
        ...
        stage('Quality Tests') {
          steps {
            ...
            sh 'docker tag nodeapp-dev:trunk koton00beng/nodeapp-dev:latest'
            sh 'docker push koton00beng/nodeapp-dev:latest'
          }
        }
      }
      post {
            ...
            steps {
                    retry(3) {
                        timeout(time:10, unit: 'MINUTES') {
                            sh 'docker tag nodeapp-dev:trunk koton00beng/nodeapp-prod:latest'
                            sh 'docker push koton00beng/nodeapp-prod:latest'
                            sh 'docker save koton00beng/nodeapp-prod:latest | gzip > nodeapp-prod-golden.tar.gz'
                        }
                    }
